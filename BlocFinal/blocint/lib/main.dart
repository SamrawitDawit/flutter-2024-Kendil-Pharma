...
void main() {
  final dataProvider = DataProvider(baseUrl: 'http://192.168.107.147:3009');
  final listMedicineProvider = ListMedicineProvider('http://192.168.107.147:3009');
  final listMedicineRepository = ListMedicineRepository(listMedicineProvider);
  final medicineProvider = MedicineProvider('http://192.168.107.147:3009');
  final medicineRepository = MedicineRepository(medicineProvider);

  final userProvider = UserProvider('http://192.168.107.147:3009');
  final userRepository = UserRepository(userProvider);

  final orderDataProvider = OrderDataProvider(baseUrl: 'http://192.168.107.147:3009');
  ...
  final Order2Repository order2Repository = Order2Repository(
    dataProvider: Order2DataProvider(baseUrl: 'http://192.168.107.147:3009'),
  );
  
  final userDataProvider2 = UserDataProvider2(baseUrl: 'http://192.168.107.147:3009');
  final userRepository2 = UserRepository2(dataProvider: userDataProvider2);

  final loginDataProvider = LoginDataProvider(baseUrl: 'http://192.168.107.147:3009');
