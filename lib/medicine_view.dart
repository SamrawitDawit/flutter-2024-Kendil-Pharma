      ...
      body: Padding(
        ...
        child: Container(
          child: Column(children: [
            Text(
              medicineName ?? 'Folic Acid Tablet',
              style: TextStyle(
                  color: Colors.blue,
            ...
            Text(amount ?? '1 strip of 10 tablet',
              ...
              child: Column(
                children: [
                  Text('Composition',
                      style: TextStyle(fontWeight: FontWeight.w300)),
                  Text(
                    composition ?? 'Amidipine(5mg) + Atenolol(50mg)',
              ...
              child: Container(
                child: Column(
                  children: [
                    ...
                    Text(
                      sideEffects ??
                          'Sleepiness, Headache, Ankle swelling, Flushing(sense of warmth in the '
                              'face, ears, neck and trunk), Slow heart rate, Palpitations, Nausea, Edema,(swelling),'
                              'Constipation, Tiredness, Cold extremities',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    )
                  ],
                ),
      ...
      bottomNavigationBar: Container(
          ...
          child: (Row(
            ...
            children: [
              ...
              if (is_user ??
                  true) // Use a default value of false if is_user is null
                ElevatedButton(
                  onPressed: () {
